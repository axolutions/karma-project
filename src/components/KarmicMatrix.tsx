...
const KarmicMatrix: React.FC<KarmicMatrixProps> = ({ 
  ...
  const boxPositions = [
    { top: '10%', left: '19%', translateX: '-50%', translateY: '-50%' },   // Position 1 - top left (3)
    { top: '10%', left: '72%', translateX: '-50%', translateY: '-50%' },   // Position 2 - top right (1)
    ...
    { top: '84%', left: '29%', translateX: '-50%', translateY: '-50%' },   // Position 5 - bottom left (11)
    { top: '71%', left: '46%', translateX: '-50%', translateY: '-50%' },   // Position 6 - bottom middle (9)
    { top: '82%', left: '68%', translateX: '-50%', translateY: '-50%' },   // Position 7 - bottom right (3)
