...
const KarmicMatrix: React.FC<KarmicMatrixProps> = ({ 
  ...
  const boxPositions = [
    { top: '8%', left: '18%', translateX: '-50%', translateY: '-50%' },   // Position 1 - top left (3)
    { top: '8%', left: '73%', translateX: '-50%', translateY: '-50%' },   // Position 2 - top right (1)
    ...
    { top: '87%', left: '32%', translateX: '-50%', translateY: '-50%' },   // Position 5 - bottom left (11)
