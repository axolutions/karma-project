...
const KarmicMatrix: React.FC<KarmicMatrixProps> = ({ 
  ...
  const boxPositions = [
    { top: '12%', left: '20%', translateX: '-50%', translateY: '-50%' },   // Position 1 - top left (3)
    { top: '12%', left: '72%', translateX: '-50%', translateY: '-50%' },   // Position 2 - top right (1)
    { top: '47%', left: '20%', translateX: '-50%', translateY: '-50%' },   // Position 3 - middle left (9)
    { top: '46%', left: '72%', translateX: '-50%', translateY: '-50%' },   // Position 4 - middle right (4)
    { top: '82%', left: '27%', translateX: '-50%', translateY: '-50%' },   // Position 5 - bottom left (11)
    { top: '71%', left: '46%', translateX: '-50%', translateY: '-50%' },   // Position 6 - bottom middle (9)
    { top: '78%', left: '70%', translateX: '-50%', translateY: '-50%' },   // Position 7 - bottom right (3)
