...
const KarmicMatrix: React.FC<KarmicMatrixProps> = ({ 
  ...
  const boxPositions = [
    { top: '6%', left: '16%', translateX: '-50%', translateY: '-50%' },   // Position 1 - top left (3)
    { top: '6%', left: '75%', translateX: '-50%', translateY: '-50%' },   // Position 2 - top right (1)
    ...
    { top: '90%', left: '35%', translateX: '-50%', translateY: '-50%' },   // Position 5 - bottom left (11)
    { top: '71%', left: '46%', translateX: '-50%', translateY: '-50%' },   // Position 6 - bottom middle (9)
    { top: '85%', left: '65%', translateX: '-50%', translateY: '-50%' },   // Position 7 - bottom right (3)
